...
def seed_sro_data(conn):
    ...
    hotels = [
        (
            ...
            "Renato Apartments",
            "Renato Hotel",
            "Renato Apartments, Skid Row, Los Angeles, CA",
            1920,
            2010,
            "Working-Class Hotel",
            ...
            96,
            450.0,
            "Built utilizing a $9.5 million loan from the City of Los Angeles. Rent subsidized by HACLA.",
            "Operating",
        ),
        (
            king_eddy_id,
            "King Edward Hotel",
            "King Eddy Hotel",
            "5th St and Los Angeles St, Los Angeles, CA 90013",
            1906,
            2018,
            "Palace Hotel",
            ...
            150,
            400.0,
            "Acquired by AHF's Healthy Housing Foundation. Operates single rooms with shared facilities.",
            "Operating",
        ),
        (
            baltimore_id,
            ...
            215,
            400.0,
            "Acquired by AHF. Operates low-barrier SRO units.",
            "Operating",
        ),
        (
            barclay_id,
            "Barclay Hotel",
            "The Van Nuys Hotel",
            "103 W 4th St, Los Angeles, CA 90013",
            1896,
            2018,
            "Palace Hotel",
            "AIDS Healthcare Foundation",
            158,
            400.0,
            "The first luxury 'palace' hotel in western downtown, later converted to rooming house levels.",
            "Operating",
        ),
        (
            madison_id,
            "Madison Hotel",
            "The Madison",
            "Madison Hotel, 7th St, Los Angeles, CA",
            1920,
            2018,
            "Working-Class Hotel",
            "AIDS Healthcare Foundation",
            200,
            400.0,
            "AHF SRO providing single rooms with shared showers.",
            "Operating",
        ),
    ]
    ...
    violations = [
        (
            ...
            renato_id,
            "Plumbing/Sewage",
            "Raw sewage flooding directly into tenants' units; unaddressed leaks.",
            "Inhumane/Critical",
            "2024-12-12",
            "Washington v. Renato Apartments, LP Lawsuit",
            "Under Litigation",
        ),
        (
            str(uuid.uuid4()),
            renato_id,
            "Elevator",
            "Broken elevators causing long-term non-accessibility for disabled and elderly seniors.",
            "Severe",
            "2024-12-12",
            "Washington v. Renato Apartments, LP Lawsuit",
            "Under Litigation",
        ...
        (
            ...
            renato_id,
            "Infestation",
            "Rampant and long-term bedbug and cockroach infestations left untreated.",
            "Severe",
            "2024-12-12",
            "Washington v. Renato Apartments, LP Lawsuit",
            "Under Litigation",
        ...
        (
            ...
            "Crumbling walls and ceilings with active water intrusion.",
            "Moderate",
            "2024-12-12",
            "Washington v. Renato Apartments, LP Lawsuit",
            "Under Litigation",
        ...
        (
            ...
            "Inoperable smoke detectors throughout the residential facility.",
            "Severe",
            "2024-12-12",
            "Washington v. Renato Apartments, LP Lawsuit",
            "Under Litigation",
        ...
        (
            ...
            renato_id,
            "Security/Trespass",
            "Unsecured doors and windows allowing trespassers to commit vandalism and theft inside hallways.",
            "Severe",
            "2024-12-12",
            "Washington v. Renato Apartments, LP Lawsuit",
            "Under Litigation",
        ...
        (
            str(uuid.uuid4()),
            renato_id,
            "Unaddressed Death Trauma",
            "Decorated veteran committed suicide by jumping from the 5th floor into the courtyard. Tenants forced to walk past his mangled body for hours. Management failed to clean up blood/matter, forcing tenants to clean it themselves.",
            "Inhumane/Critical",
            "2024-12-12",
            "Washington v. Renato Apartments, LP Lawsuit",
            "Under Litigation",
        ...
        (
            ...
            king_eddy_id,
            "Infestation",
            "AHF-managed property cited for persistent cockroach infestations.",
            "Moderate",
            "2023-11-17",
            "Los Angeles Times Investigation (Nov 2023)",
            "Active Violation",
        ),
        (
            str(uuid.uuid4()),
            king_eddy_id,
            "Plumbing/Sewage",
            "Clogged toilets and failing plumbing infrastructure.",
            "Moderate",
            "2023-11-17",
            "Los Angeles Times Investigation (Nov 2023)",
            "Active Violation",
    ...
    financials = [
        (
            ...
            1200,
            500000000.0,
            "2023 (Financial Collapse)",
            "Collapsed into complete receivership in April 2023. Out of 29 properties, 10 SRO buildings are now targeted for demolition or conversion. Estimated portfolio repair cost is $500M.",
            "Court Receivership Documents / iHFG White Paper",
        ),
        (
            str(uuid.uuid4()),
            ...
            15000000.0,
            "6 Years (2017-2023)",
            "Spent nearly $200M acquiring properties and $30M on repairs. Reported over $15M in operational losses due to high costs of retrofitting century-old hotels.",
            "AHF Corporate Disclosures / Real Deal Report",
        ),
        (
            str(uuid.uuid4()),
            "SRO Housing Corporation",
            ...
            0.0,
            "Ongoing",
            "Operates 15 SRO buildings in Skid Row, but reports that 10 of those 15 buildings are actively operating at an operational loss.",
            "SRO Housing Corporation Annual Audit",
        ),
    ]
    ...
    history = [
        (
            ...
            "The King Edward Hotel's basement saloon (King Eddy Saloon) served as the primary setting and inspiration for John Fante's legendary 1939 novel 'Ask the Dust'.",
        ),
        (
            str(uuid.uuid4()),
            king_eddy_id,
            "James M. Cain - Research Spot",
            "Famed hardboiled novelist James M. Cain spent considerable time at the King Edward Saloon researching characters and local color for his classic book 'The Postman Always Rings Twice'.",
        ),
    ]
