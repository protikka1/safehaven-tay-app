"""Generate synthetic test fixtures only; no names or identifiers are real."""
...
DB_PATH = Path(__file__).resolve().with_name("recovery_app_populated.db")
...
def setup_and_seed_100_youth():
    ...
    facilities_data = [
        (fac_ids[0], "Example Recovery Health Hub", "Substance_Use_Hub", "100 Example Avenue, Test City, CA 90000", "213-555-0199", 40, 8),
        (fac_ids[1], "Example Care First Village", "Detox_Center", "200 Example Avenue, Test City, CA 90000", "213-555-0102", 50, 15),
        (fac_ids[2], "Example Supportive Housing", "PSH_Complex", "300 Example Avenue, Test City, CA 90000", "213-627-9000", 120, 2)
    ]
    ...
    caseworkers_data = [
        (cw_ids[0], "Example Caseworker One", "Peer Support Specialist", "Example TAY Agency", "213-555-0111", 1),
        (cw_ids[1], "Example Caseworker Two", "Housing Navigator", "Example Supportive Housing", "213-555-0222", 1),
        (cw_ids[2], "Example Caseworker Three", "Social Worker", "Example Community Agency", "213-555-0333", 1),
        (cw_ids[3], "Example Caseworker Four", "Peer Support Specialist", "Example Recovery Health Hub", "213-555-0444", 1)
    ]
    ...
    clinicians_data = [
        (clin_ids[0], "Dr. Example Clinician One", "0000000000", "Addiction Medicine", "213-555-0800"),
        (clin_ids[1], "Dr. Example Clinician Two", "0000000001", "Pediatric Immunology", "415-555-1278")
    ]
    ...
    first_names = [f"ExampleFirst{i:02d}" for i in range(1, 31)]
    last_names = [f"ExampleLast{i:02d}" for i in range(1, 21)]
