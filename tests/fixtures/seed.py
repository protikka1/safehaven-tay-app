"""Create a local SafeHaven test database using synthetic fixtures only."""
...
def seed_reference_data(connection: sqlite3.Connection) -> None:
    ...
    connection.executemany(
        ...
        [
            (
                "facility-health-hub",
                "Example Recovery Health Hub",
                "Substance_Use_Hub",
                "100 Example Avenue, Test City, CA 90000",
                "213-555-0199",
                40,
                8,
            ),
            (
                ...
                "Example Care First Village",
                "Detox_Center",
                "200 Example Avenue, Test City, CA 90000",
                "213-555-0102",
                50,
                15,
            ),
    ...
    connection.executemany(
        ...
        [
            (
                "caseworker-marcus",
                "Example Caseworker One",
                "Peer Support Specialist",
                "Example TAY Service Agency",
                "213-555-0111",
                1,
            ),
        ],
